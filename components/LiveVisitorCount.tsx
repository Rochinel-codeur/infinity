...
export function LiveVisitorCount() {
  ...
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-900/20 border border-green-500/30 mb-8 backdrop-blur-md transition-all hover:bg-green-900/30 shadow-[0_0_15px_rgba(34,197,94,0.15)]">
      ...
      <span className="text-xs sm:text-sm font-bold text-green-400 tracking-wide">
